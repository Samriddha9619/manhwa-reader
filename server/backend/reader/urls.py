...
urlpatterns = [
    path('', views.ComicListView.as_view(), name='comic-list'),
    path('comics/', views.ComicDetailView.as_view(), name='comics'),
    
    path('categories/', views.CategoryListView.as_view(), name='category-list'),
    path('categories/<int:pk>/', views.CategoryDetailView.as_view(), name='category-detail'),

    path('comic/slug/<slug:slug>/', views.ComicDetailView.as_view(), name='comic-detail'),
    path('comic/slug/<slug:slug>/chapters/<slug:chapter_slug>/', views.ChapterListView.as_view(), name='chapter-detail'),

    path('profile/', views.ProfileView.as_view(), name='profile'),
    path('profile/bookmarks/', views.BookmarkListView.as_view(), name='bookmarks'),
